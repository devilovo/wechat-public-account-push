export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx7169abf0dfa786f7",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "b7529777bdb415971cf3b3fb926fc532",
  ...
  USERS: [
    {
      ...
      id: "ogIpU6DwYbU-aTgJEVpwcQAnpr-Y",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "qwujCpphH0os8mx5afmusb-DBG2f3rD06Calq15_t2I",
      // 所在省份
      province: "山西",
      // 所在城市
      city: "吕梁",
  ...
  CALLBACK_TEMPLATE_ID: "Skke3LAwvLDZ8MdJU3sEpy2x-i8lOy1fHdKvp5RGBrA",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "ogIpU6HakyRgt8jY46LcIHk6-X7U",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
